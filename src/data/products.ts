...
export const products: Product[] = [
  {
    ...
    price: 450,
    originalPrice: 700,
    description: 'Multi-layered beads necklace with shells',
  ...
  {
    id: 6,
    name: 'Gold-chained waistbead with multi-layered beads',
    price: 49.99,
    originalPrice: 69.99,
  ...
  {
    id: 7,
    name: 'Pearlwaist beads',
    price: 34.99,
    description: 'Handcrafted pearl waist beads with multi-layered beads.',
    image: "https://res.cloudinary.com/dozb1abfn/image/upload/v1757532357/download_1_febho6.jpg",
    category: 'Waistbead',
    categorySlug: 'waistbead',
    rating: 4.7,
    reviewCount: 445,
