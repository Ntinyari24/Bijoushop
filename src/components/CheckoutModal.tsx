    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm">
        <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl text-center p-8">
          ...
          <button
            onClick={handleClose}
            className="w-full bg-gradient-to-r from-jungle-600 to-earth-700 text-white py-3 rounded-xl font-semibold hover:from-jungle-700 hover:to-earth-800 transition-all duration-200"
          >
            Continue Shopping
          </button>
        </div>
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="flex items-center space-x-4">
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${
                currentStep >= 1 ? 'bg-jungle-600 text-white' : 'bg-gray-200 text-gray-500'
              }`}>
                1
              </div>
              <div className={`w-16 h-1 ${currentStep >= 2 ? 'bg-jungle-600' : 'bg-gray-200'}`} />
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${
                currentStep >= 2 ? 'bg-jungle-600 text-white' : 'bg-gray-200 text-gray-500'
              }`}>
                2
              </div>
              <div className={`w-16 h-1 ${currentStep >= 3 ? 'bg-jungle-600' : 'bg-gray-200'}`} />
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${
                currentStep >= 3 ? 'bg-jungle-600 text-white' : 'bg-gray-200 text-gray-500'
              }`}>
                3
              </div>
            </div>
          ...
          <div className="flex justify-between mt-8">
            ...
            {currentStep === 1 && (
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-jungle-600 to-earth-700 text-white rounded-xl hover:from-jungle-700 hover:to-earth-800 transition-all duration-200"
              >
                Continue to Payment
              </button>
            )}
