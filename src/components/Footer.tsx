    ...
    <footer className="bg-gray-900 text-white py-12 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold">BijouShop</span>
            </div>
            <p className="text-gray-400 text-sm">
              Your premier destination for exquisite jewelry and timeless elegance.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-l-lg bg-gray-800 border border-gray-700 focus:outline-none focus:border-jungle-500 text-white"
              />
              <button className="px-4 py-2 bg-gradient-to-r from-jungle-600 to-earth-700 rounded-r-lg hover:from-jungle-700 hover:to-earth-800 transition-all duration-200">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 BijouShop. All rights reserved.
          </p>
